...
PrzykĹ‚ady:
    ...
    py split_zip_sha.py "D:\\.AI\\jazn_latka_local" --out "D:\\Desktop\\pakiet" --name jazn_latka_v14.8.5.027 --part-size-mb 480 --force
...
ARCHIVE_BASENAME = r""       # puste = nazwa folderu ĹşrĂłdĹ‚owego; wynik: <nazwa>.zip.001
