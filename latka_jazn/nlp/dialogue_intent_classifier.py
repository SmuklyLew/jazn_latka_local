...
class DialogueIntentClassifier:
    ...
    def _phrase(text: str, folded: str, marker: str) -> bool:
        ...
        # long markers: phrase match; short one-word markers: token boundary
    ...
    def _report(self, norm, folded, intent, evidence, base, secondary=None, preserve=False, creative=False, update=False, diag=False, src=False, ident=False, speech_act='unknown', question_object='unknown'):
        ...
        return DialogueIntentReport(SCHEMA_VERSION,norm,folded,intent,secondary or [],conf,evidence,preserve,creative,update,diag,src,ident,speech_act,question_object)
    def classify(self, text: str, *, previous_text: str | None = None) -> DialogueIntentReport:
        ...
        has_creative=self._has_any(norm,folded,self.CREATIVE_TERMS) or self._looks_like_large_material(text) or creative_report.creative_material_present
