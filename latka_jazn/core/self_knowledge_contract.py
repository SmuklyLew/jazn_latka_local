...
def _memory_status(cfg: JaznConfig) -> dict[str, Any]:
    ...
    return {
        "schema_version": "self_knowledge_memory_status/v14.8.5.022",
...
def build_self_knowledge_packet(config: JaznConfig | None = None, *, deep: bool = False) -> SelfKnowledgePacket:
    ...
    identity_status = {
        "schema_version": "self_knowledge_identity_status/v14.8.5.022",
    ...
    learned = {
        "schema_version": "self_knowledge_learned_procedures_status/v14.8.5.022",
    ...
    return SelfKnowledgePacket(
        ...
        affective_model_status={
            "schema_version": "self_knowledge_affective_model_status/v14.8.5.022",
...
def build_self_knowledge_summary(config: JaznConfig | None = None) -> dict[str, Any]:
    ...
    return {
        "schema_version": "self_knowledge_summary/v14.8.5.022",
